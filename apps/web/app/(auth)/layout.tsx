...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      {/* Left side - Dark background with centered video (desktop only) */}
      <div className="hidden lg:flex lg:h-auto lg:w-1/2 bg-[#0a0a0a] flex-col items-center justify-center p-8 gap-6 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="flex-1 lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-white min-h-screen lg:min-h-0"
      >
